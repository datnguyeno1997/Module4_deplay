...
//    private IProductService productService = new ProductServiceImpl();
    ...
    public String showListPage(@RequestParam(defaultValue = "0") int page, Model model) {
        ...
        Page<Product> productPage = productService.findAllWithPagination(pageable);
        model.addAttribute("products",productPage);
        return "cp/product/list";
    }

//    @GetMapping("/products")
//    public String showListPage(@RequestParam(defaultValue = "0") int page,
...
//        Page<Product> productPage = productService.findAllWithPagination(pageable,sort);
//        model.addAttribute("products", productPage);
//        return "cp/product/list";
//    }
